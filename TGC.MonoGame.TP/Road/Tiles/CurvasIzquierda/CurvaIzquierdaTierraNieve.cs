...
public class CurvaIzquierdaTierraNieve : CurvaIzquierda, IAssetLoader
{
    ...
    public static void LoadLocalModels(ContentManager content)
    {
        ...
        CurvaIzquierdaTierraNieve.LoadModel(content, "road-tiles/road-curve", AssetPaths.ContentFolder3D + "road-tiles/road-curve", AssetPaths.ContentFolderEffects + "TexturedShader", roadColormap);
