...
public class CurvaIzquierdaNieveAsfalto : CurvaIzquierda, IAssetLoader
{
    ...
    {
        CurvaIzquierdaNieveAsfalto.modelMap.Add(key, new CustomModel(
    ...
    private static void LoadModel(ContentManager content, string path, string effect, Color color)
    {
        ...
        CurvaIzquierdaNieveAsfalto.LoadModel(content, path, path, effect, color);
    }
    ...
    public static void LoadLocalModels(ContentManager content)
    {
        ...
        CurvaIzquierdaNieveAsfalto.LoadModel(content, "road-tiles/road-square", AssetPaths.ContentFolder3D + "road-tiles/road-square", AssetPaths.ContentFolderEffects + "TexturedShader", Color.DarkGreen);
        CurvaIzquierdaNieveAsfalto.LoadModel(content, "road-tiles/road-curve", AssetPaths.ContentFolder3D + "road-tiles/road-curve", AssetPaths.ContentFolderEffects + "TexturedShader", roadColormap, overlayTexture);
        CurvaIzquierdaNieveAsfalto.LoadModel(content, "buildings/suburban/building-type-s", AssetPaths.ContentFolder3D + "buildings/suburban/building-type-s", AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
    }

    public CurvaIzquierdaNieveAsfalto(
        Vector3 position,
        float rotation,
        Biome biome
