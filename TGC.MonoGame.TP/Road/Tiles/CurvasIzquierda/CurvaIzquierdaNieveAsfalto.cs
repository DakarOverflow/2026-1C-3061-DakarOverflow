...
public class CurvaIzquierdaNieveAsfalto : CurvaIzquierda, IAssetLoader
{
    ...
    public static void LoadLocalModels(ContentManager content)
    {
        ...
        CurvaIzquierdaNieveAsfalto.LoadModel(content, "road-tiles/road-curve", AssetPaths.ContentFolder3D + "road-tiles/road-curve", AssetPaths.ContentFolderEffects + "TexturedShader", roadColormap);
