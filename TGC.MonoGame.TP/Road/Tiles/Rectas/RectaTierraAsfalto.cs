...
public class RectaTierraAsfalto : Recta, IAssetLoader
{
    ...
    {
        RectaTierraAsfalto.modelMap.Add(key, new CustomModel(
    ...
    private static void LoadModel(ContentManager content, string path, string effect, Color color)
    {
        ...
        RectaTierraAsfalto.LoadModel(content, path, path, effect, color);
    }   
    ...
    public static void LoadLocalModels(ContentManager content)
    {
        ...
        RectaTierraAsfalto.LoadModel(content, "road-tiles/road-square", AssetPaths.ContentFolder3D + "road-tiles/road-square", AssetPaths.ContentFolderEffects + "TexturedShader", Color.DarkGreen);
        RectaTierraAsfalto.LoadModel(content, "road-tiles/road-straight", AssetPaths.ContentFolder3D + "road-tiles/road-straight",  AssetPaths.ContentFolderEffects + "TexturedShader", roadColormap, overlayTexture);

        RectaTierraAsfalto.LoadModel(content, "road-tiles/light-curved", AssetPaths.ContentFolder3D + "road-tiles/light-curved",
            AssetPaths.ContentFolderEffects + "TexturedShader", roadColormap);
        RectaTierraAsfalto.LoadModel(content, "buildings/suburban/building-type-c", AssetPaths.ContentFolder3D + "buildings/suburban/building-type-c",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaTierraAsfalto.LoadModel(content, "buildings/suburban/building-type-n", AssetPaths.ContentFolder3D + "buildings/suburban/building-type-n",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaTierraAsfalto.LoadModel(content, "buildings/suburban/planter", AssetPaths.ContentFolder3D + "buildings/suburban/planter",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaTierraAsfalto.LoadModel(content, "buildings/suburban/driveway-long", AssetPaths.ContentFolder3D + "buildings/suburban/driveway-long",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaTierraAsfalto.LoadModel(content, "buildings/suburban/tree-small", AssetPaths.ContentFolder3D + "buildings/suburban/tree-small",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaTierraAsfalto.LoadModel(content, "buildings/suburban/tree-tall", AssetPaths.ContentFolder3D + "buildings/suburban/tree-large",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaTierraAsfalto.LoadModel(content, "buildings/suburban/fence-3x3", AssetPaths.ContentFolder3D + "buildings/suburban/fence-3x3",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaTierraAsfalto.LoadModel(content, "buildings/suburban/path-stones-messy", AssetPaths.ContentFolder3D + "buildings/suburban/path-stones-messy",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
    }

    public RectaTierraAsfalto(
        Vector3 position,
        float rotation,
        Biome biome
