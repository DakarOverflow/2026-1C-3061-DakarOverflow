...
public class RectaAsfalto : Recta, IAssetLoader
{
    ...
    public static void LoadLocalModels(ContentManager content)
    {
        ...
        RectaAsfalto.LoadModel(content, "road-tiles/light-curved", AssetPaths.ContentFolder3D + "road-tiles/light-curved",
            AssetPaths.ContentFolderEffects + "TexturedShader", roadColormap);
        RectaAsfalto.LoadModel(content, "buildings/suburban/building-type-c", AssetPaths.ContentFolder3D + "buildings/suburban/building-type-c",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaAsfalto.LoadModel(content, "buildings/suburban/building-type-n", AssetPaths.ContentFolder3D + "buildings/suburban/building-type-n",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaAsfalto.LoadModel(content, "buildings/suburban/planter", AssetPaths.ContentFolder3D + "buildings/suburban/planter",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaAsfalto.LoadModel(content, "buildings/suburban/driveway-long", AssetPaths.ContentFolder3D + "buildings/suburban/driveway-long",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaAsfalto.LoadModel(content, "buildings/suburban/tree-small", AssetPaths.ContentFolder3D + "buildings/suburban/tree-small",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaAsfalto.LoadModel(content, "buildings/suburban/tree-tall", AssetPaths.ContentFolder3D + "buildings/suburban/tree-large",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaAsfalto.LoadModel(content, "buildings/suburban/fence-3x3", AssetPaths.ContentFolder3D + "buildings/suburban/fence-3x3",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaAsfalto.LoadModel(content, "buildings/suburban/path-stones-messy", AssetPaths.ContentFolder3D + "buildings/suburban/path-stones-messy",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
    }
