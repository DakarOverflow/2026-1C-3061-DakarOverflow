...
public class RectaTierraNieve : Recta, IAssetLoader
{
    ...
    {
        RectaTierraNieve.modelMap.Add(key, new CustomModel(
    ...
    private static void LoadModel(ContentManager content, string path, string effect, Color color)
    {
        ...
        RectaTierraNieve.LoadModel(content, path, path, effect, color);
    }   
    ...
    public static void LoadLocalModels(ContentManager content)
    {
        ...
        RectaTierraNieve.LoadModel(content, "road-tiles/road-straight", AssetPaths.ContentFolder3D + "road-tiles/road-straight",  AssetPaths.ContentFolderEffects + "TexturedShader", roadColormap, overlayTexture);
        ...
        RectaTierraNieve.LoadModel(content, "buildings/suburban/building-type-c", AssetPaths.ContentFolder3D + "buildings/suburban/building-type-c",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaTierraNieve.LoadModel(content, "buildings/suburban/building-type-n", AssetPaths.ContentFolder3D + "buildings/suburban/building-type-n",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaTierraNieve.LoadModel(content, "buildings/suburban/planter", AssetPaths.ContentFolder3D + "buildings/suburban/planter",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaTierraNieve.LoadModel(content, "buildings/suburban/driveway-long", AssetPaths.ContentFolder3D + "buildings/suburban/driveway-long",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaTierraNieve.LoadModel(content, "buildings/suburban/tree-small", AssetPaths.ContentFolder3D + "buildings/suburban/tree-small",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaTierraNieve.LoadModel(content, "buildings/suburban/tree-tall", AssetPaths.ContentFolder3D + "buildings/suburban/tree-large",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaTierraNieve.LoadModel(content, "buildings/suburban/fence-3x3", AssetPaths.ContentFolder3D + "buildings/suburban/fence-3x3",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
        RectaTierraNieve.LoadModel(content, "buildings/suburban/path-stones-messy", AssetPaths.ContentFolder3D + "buildings/suburban/path-stones-messy",
            AssetPaths.ContentFolderEffects + "TexturedShader", suburbanColormap);
    }

    public RectaTierraNieve(
        Vector3 position,
        float rotation,
        Biome biome
